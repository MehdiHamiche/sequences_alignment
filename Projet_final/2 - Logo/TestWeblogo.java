...
class Weblogo {
	...
	public void getWbAdressAndImage() {
...
//////////////Permettre de lire le fichier en string pour les paramètres//////////////
		  ...
		  String encodedSequence = URLEncoder.encode(sb.toString(), StandardCharsets.UTF_8);
...
//////////////Utilisation InputStream sur co et transformation en byte[] pour pouvoir afficher l'image facilement//////////////
		  ...
		  ImageIO.write(bImage, "png", new File("C:\\Users\\manal\\Downloads\\SEQUENCES_LOGO.png"));
...
////////////Création de JFrame pour afficher le logo////////////
		  ...
		  jButton.setFont(new java.awt.Font("Tw Cen MT", 0, 14)); // NOI18N
	   	  ...
	   	  String lienFichier = "C:\\Users\\manal\\Downloads\\SEQUENCES_LOGO.png";
